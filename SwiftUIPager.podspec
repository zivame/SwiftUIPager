Pod::Spec.new do |s|
  ...
  s.name         = "SwiftUIPager"
  s.version      = "1.0.0" # pod trunk me --verbose
  ...
  s.homepage     = "https://github.com/zivame/newstack_ios"
  ...
  s.source       = { :git => "https://github.com/mozammild/SwiftUIPager.git", :tag => "#{s.version}" }
